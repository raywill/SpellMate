...
const i18n = {
    ...
    translations: {
        zh: {
            ...
            settingsTitle: '高级设置',
            settingSilence: '录制停顿时间:',
            settingVolume: '录音敏感度:',
            volumeLevelSoft: '轻声',
            volumeLevelNormal: '普通声',
            volumeLevelLoud: '大声',
            settingRepeatCount: '重复播报:',
            settingAutoPlay: '自动播报停顿时间:',
            autoPlayContinuous: '连续',
            autoPlayVeryShorter: '较短',
            autoPlayShorter: '短',
            autoPlayModerate: '适中',
            autoPlayLonger: '长',
            autoPlayVeryLong: '极长',
            ...
            alertVersionUpgrade: '发现新版本 v{version}，已自动升级',
        ...
        en: {
            ...
            settingSilence: 'Pause Duration:',
            settingVolume: 'Recording Sensitivity:',
            volumeLevelSoft: 'Soft',
            volumeLevelNormal: 'Normal',
            volumeLevelLoud: 'Loud',
            settingRepeatCount: 'Repeat Count:',
            settingAutoPlay: 'Auto Play Interval:',
            autoPlayContinuous: 'Continuous',
            autoPlayVeryShorter: 'Very Short',
            ...
            alertVersionUpgrade: 'New version v{version} detected, automatically upgraded',
        ...
        ja: {
            ...
            settingsTitle: '詳細設定',
            settingSilence: '録音停止時間:',
            settingVolume: '録音感度:',
            volumeLevelSoft: '小声',
            volumeLevelNormal: '普通',
            volumeLevelLoud: '大声',
            settingRepeatCount: '繰り返し回数:',
            settingAutoPlay: '自動再生間隔:',
            autoPlayContinuous: '連続',
            autoPlayVeryShorter: 'やや短い',
            autoPlayShorter: '短い',
            autoPlayModerate: '適度',
            autoPlayLonger: '長い',
            autoPlayVeryLong: '非常に長い',
            autoPlayManual: '手動',
            autoPlayFast: '短い',
            autoPlaySlow: '長い',
            autoPlayEnabled: '有効',
            ...
            alertVersionUpgrade: '新バージョン v{version} を検出、自動的にアップグレードしました',
        ...
        fr: {
            ...
            settingSilence: 'Durée de pause:',
            settingVolume: 'Sensibilité:',
            volumeLevelSoft: 'Doux',
            volumeLevelNormal: 'Normal',
            volumeLevelLoud: 'Fort',
            settingRepeatCount: 'Répétitions:',
            settingAutoPlay: 'Intervalle de lecture:',
            autoPlayContinuous: 'Continu',
            autoPlayVeryShorter: 'Très court',
            autoPlayShorter: 'Court',
            autoPlayModerate: 'Modéré',
            autoPlayLonger: 'Long',
            autoPlayVeryLong: 'Très long',
            autoPlayManual: 'Manuel',
            autoPlayFast: 'Court',
            autoPlaySlow: 'Long',
            autoPlayEnabled: 'Activé',
            autoPlayDisabled: 'Désactivé',
            ...
            alertVersionUpgrade: 'Nouvelle version v{version} détectée, mise à niveau automatique',
        ...
        de: {
            ...
            settingSilence: 'Pausendauer:',
            settingVolume: 'Empfindlichkeit:',
            volumeLevelSoft: 'Leise',
            volumeLevelNormal: 'Normal',
            ...
            alertVersionUpgrade: 'Neue Version v{version} erkannt, automatisch aktualisiert',
        ...
        es: {
            ...
            settingSilence: 'Duración de pausa:',
            settingVolume: 'Sensibilidad:',
            volumeLevelSoft: 'Bajo',
            volumeLevelNormal: 'Normal',
            volumeLevelLoud: 'Alto',
            settingRepeatCount: 'Repeticiones:',
            settingAutoPlay: 'Intervalo de reproducción:',
            autoPlayContinuous: 'Continuo',
            autoPlayVeryShorter: 'Muy corto',
            autoPlayShorter: 'Corto',
            autoPlayModerate: 'Moderado',
            autoPlayLonger: 'Largo',
            autoPlayVeryLong: 'Muy largo',
            autoPlayManual: 'Manual',
            autoPlayFast: 'Corto',
            autoPlaySlow: 'Largo',
            autoPlayEnabled: 'Sí',
            ...
            alertVersionUpgrade: 'Nueva versión v{version} detectada, actualización automática',
        ...
        ko: {
            ...
            settingsTitle: '고급 설정',
            settingSilence: '일시정지 시간:',
            settingVolume: '녹음 감도:',
            volumeLevelSoft: '작게',
            volumeLevelNormal: '보통',
            volumeLevelLoud: '크게',
            settingRepeatCount: '반복 횟수:',
            settingAutoPlay: '자동 재생 간격:',
            autoPlayContinuous: '연속',
            autoPlayVeryShorter: '매우 짧게',
            autoPlayShorter: '짧게',
            autoPlayModerate: '적당',
            autoPlayLonger: '길게',
            autoPlayVeryLong: '매우 길게',
            autoPlayManual: '수동',
            autoPlayFast: '짧게',
            autoPlaySlow: '길게',
            autoPlayEnabled: '활성화',
            autoPlayDisabled: '비활성화',
            settingLanguage: '언어:',
            timesUnit: '회',
            ...
            alertVersionUpgrade: '새 버전 v{version}이 감지되어 자동으로 업그레이드되었습니다',
        ...
        ru: {
            ...
            settingSilence: 'Длительность паузы:',
            settingVolume: 'Чувствительность:',
            volumeLevelSoft: 'Тихо',
            volumeLevelNormal: 'Нормально',
            ...
            alertVersionUpgrade: 'Обнаружена новая версия v{version}, автоматически обновлено',
